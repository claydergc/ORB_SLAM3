...
void ImageGrabber::GrabImageLeft(const sensor_msgs::ImageConstPtr &img_msg)
{
  ...
  //std::cout<< "t_im_left: " << imgLeftBuf.front()->header.stamp.toSec() << std::endl;
...
void ImageGrabber::GrabImageRight(const sensor_msgs::ImageConstPtr &img_msg)
{
  ...
  //std::cout<< "t_im_right: " << imgRightBuf.front()->header.stamp.toSec() << std::endl;
...
void ImageGrabber::SyncWithImu()
{
  ...
  while(1)
  {
    ...
    if (!imgLeftBuf.empty()&&!imgRightBuf.empty()&&!mpImuGb->imuBuf.empty())
    {
      ...
      //if( abs(tImLeft - mpImuGb->imuBuf.back()->header.stamp.toSec()) > 0.07 ) {
        //std::cout << "big imu time difference" << std::endl;  
        continue;
      }
